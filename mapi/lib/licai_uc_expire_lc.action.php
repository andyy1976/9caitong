...
class licai_uc_expire_lc
{
	public function index(){
		...
		if ($user_id >0){
			...
			if(strim(base64_decode($GLOBALS['request']["user_name"]))!="")
			{
				$condition .= " and lco.user_name like '%".strim(base64_decode($GLOBALS['request']["user_name"]))."%'";
				$search["user_name"] = strim(base64_decode($GLOBALS['request']["user_name"]));
			}
