...
class ewswin_confirm
{
	public function index(){
		...
		//风险保证金 倍率
		//开始交易时间
		$borrow_money = intval(base64_decode($GLOBALS['request']['borrow_money']));
		...
		$ctype = intval(base64_decode($GLOBALS['request']['ctype']));
		
		$time_limit_num = intval(base64_decode($GLOBALS['request']['time_limit_num']));
