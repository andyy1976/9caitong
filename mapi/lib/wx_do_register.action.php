...
class wx_do_register{
	public function index()
	{
		...
		$verify_coder=strim(base64_decode($GLOBALS['request']['code']));
		$province=strim(base64_decode($GLOBALS['request']['province']));
		$city=strim(base64_decode($GLOBALS['request']['city']));

		$user_data=array();
		$user_data['mobile'] = $mobile;
		$user_data['wx_openid']=strim(base64_decode($GLOBALS['request']['wx_openid']));
		$user_name=$user_data['user_name']=strim(base64_decode($GLOBALS['request']['user_name']));
		$user_data['sex']=strim(base64_decode($GLOBALS['request']['sex']));
		$user_data['referer'] = strim(base64_decode($GLOBALS['request']['referer']));
