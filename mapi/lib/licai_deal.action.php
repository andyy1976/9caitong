...
class licai_deal
{
	public function index(){
		...
		$root['view_data'] = WAP_SITE_DOMAIN.wap_url("index","licai_deal#index",array("id"=>$id,"view_data"=>1,"app"=>1));
		$root['view_data'] = str_replace("/mapi","", $root['view_data']);
		$root['url_detail'] = WAP_SITE_DOMAIN.wap_url("index","licai_deal_detail#index",array("id"=>$id,"app"=>1));
