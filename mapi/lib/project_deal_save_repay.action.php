...
class project_deal_save_repay
{
	public function index(){
		...
		$order_id = intval(base64_decode($GLOBALS["request"]['id']));
		...
		$order_info['repay_memo'] = strim(base64_decode($GLOBALS["request"]['repay_memo']));
		...
		$order_info['logistics_company'] = strim(base64_decode($GLOBALS["request"]['logistics_company']));
		$order_info['logistics_links'] = strim(base64_decode($GLOBALS["request"]['logistics_links']));
		$order_info['logistics_number'] = strim(base64_decode($GLOBALS["request"]['logistics_number']));
