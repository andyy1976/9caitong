...
class project_deal_support
{
	public function index(){
		...
		$type = intval(base64_decode($_REQUEST['type']));
		$user_name = strim(base64_decode($_REQUEST['user_name']));
		$mobile = strim(base64_decode($_REQUEST['mobile']));
		$repay_status = intval(base64_decode($_REQUEST['repay_status']));
