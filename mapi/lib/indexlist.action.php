...
class indexlist
{
	...
	{		
		...
		$type = addslashes(base64_decode($GLOBALS['request']['type']));
		$cid = intval(base64_decode($GLOBALS['request']['cid']));
		$keyword = addslashes(base64_decode($GLOBALS['request']['tag']));
		$is_hot = intval(base64_decode($GLOBALS['request']['is_hot']));
		$is_new = intval(base64_decode($GLOBALS['request']['is_new']));
		$page = intval(base64_decode($GLOBALS['request']['page']))>0?intval(base64_decode($GLOBALS['request']['page'])):1;
