...
class licai_deals
{
	public function index(){
		...
		$filter_parms['type'] = $type = isset($GLOBALS['request']['type']) ? intval(base64_decode($GLOBALS['request']['type'])) : 0;
		//起购金额
		$filter_parms['money'] = $money = isset($GLOBALS['request']['money']) ? intval(base64_decode($GLOBALS['request']['money'])) : 0;
		//年化收益
		$filter_parms['rate'] = $rate = isset($GLOBALS['request']['rate']) ? intval(base64_decode($GLOBALS['request']['rate'])) : 0;
		
		$filter_parms['sortby'] = $sortby = isset($GLOBALS['request']['sortby']) ? strim(base64_decode($GLOBALS['request']['sortby'])) : "";
		$filter_parms['descby'] = $descby = isset($GLOBALS['request']['descby']) ?strtoupper(strim(base64_decode($GLOBALS['request']['descby']))) : "DESC";
