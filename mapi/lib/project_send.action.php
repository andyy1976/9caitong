...
class project_send
{
	public function index(){
		...
		*/
		...
		$root['WAP_SITE_DOMAIN'] = str_replace("/mapi", "", WAP_SITE_DOMAIN.APP_ROOT);//站点域名;
		$root['WAP_SITE_DOMAIN'] = str_replace("http://", "", $root['WAP_SITE_DOMAIN']);//站点域名;
		$root['WAP_SITE_DOMAIN'] = str_replace("https://", "", $root['WAP_SITE_DOMAIN']);//站点域名;
		...
		$page = intval(base64_decode($_REQUEST['p']));
