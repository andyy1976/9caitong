...
class learn_activity
{
	public function index(){
		...
		$root['rrruid'] = intval(base64_decode($GLOBALS['request']['rrruid']));
		...
		if($status == 1){
			...
			$share_url = WAP_SITE_DOMAIN.wap_url("index","register");
			...
			$info['content'] = str_replace("./public/",WAP_SITE_DOMAIN.APP_ROOT."/../public/",$info['content']);
