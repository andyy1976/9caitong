...
class uc_save_incharge
{
	public function index(){
		...
		$payment_id = intval(base64_decode($GLOBALS['request']['payment_id']));
		$money = floatval(base64_decode($GLOBALS['request']['money']));
		$bank_id = addslashes(htmlspecialchars(trim(base64_decode($GLOBALS['request']['bank_id']))));
		$memo = addslashes(htmlspecialchars(trim(base64_decode($GLOBALS['request']['memo']))));
