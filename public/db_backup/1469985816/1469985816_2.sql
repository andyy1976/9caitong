...
INSERT INTO `%DB_PREFIX%deal_city_link` VALUES ('3','1');
...
INSERT INTO `%DB_PREFIX%deal_loan_type` VALUES ('4','个人消费','','0','0','1','7','','./public/images/dealtype/grxf.png','','','N;','1','2|2.55|0.22|0.33|11|1.1|1.1\n3|2.3|0.21|0.28|10|1.2|1.2\n4|1.2|0.2|0.17|9|1.3|1.3\n5|0|0.19|0.06|8|1.4|1.4','1|5|0.3|0.6|15|1|1\n2|3|0.29|0.5|14|2|1.5\n3|2.5|0.28|0.4|13|3|2\n4|2|0.27|0.3|12|4|2.5\n5|1.5|0.26|0.2|11|5|3\n6|1|0.25|0.1|10|6|3.5\n7|0|0.24|0|9|7|4');
...
INSERT INTO `%DB_PREFIX%deal_loan_type` VALUES ('6','教育培训','','0','0','1','5','','./public/images/dealtype/jypx.png','','','N;','1','2|2.5|0.39|0.29|5|1.21|1.21\n3|2|0.38|0.28|4|1.22|1.22\n4|1.5|0.37|0.27|3|1.23|1.23\n5|1|0.35|0.26|2|1.24|1.24','1|5|0.3|0.6|15|1|1\n2|3|0.29|0.5|14|2|1.5\n3|2.5|0.28|0.4|13|3|2\n4|2|0.27|0.3|12|4|2.5\n5|1.5|0.26|0.2|11|5|3\n6|1|0.25|0.1|10|6|3.5\n7|0|0.24|0|9|7|4');
INSERT INTO `%DB_PREFIX%deal_loan_type` VALUES ('7','汽车消费','','0','0','1','4','','./public/images/dealtype/qcxf.png','','','N;','1','2|3|0.28|0.1|8|1|1.5\n3|2.5|0.27|0.09|7|1.1|1.6\n4|2|0.26|0.08|6|1.2|1.7\n5|1|0.25|0.07|5|1.3|1.8','1|5|0.3|0.6|15|1|1\n2|3|0.29|0.5|14|2|1.5\n3|2.5|0.28|0.4|13|3|2\n4|2|0.27|0.3|12|4|2.5\n5|1.5|0.26|0.2|11|5|3\n6|1|0.25|0.1|10|6|3.5\n7|0|0.24|0|9|7|4');
...
) ENGINE=InnoDB AUTO_INCREMENT=4721 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
INSERT INTO `%DB_PREFIX%deal_msg_list` VALUES ('4718','18865669007','0','18865669007','0','0','1455434524','0','','0','0','你的手机号为13788888888,验证码为179307','0','0');
INSERT INTO `%DB_PREFIX%deal_msg_list` VALUES ('4720','15810877391','0','你的手机号为15810877391,验证码为971526','0','0','1469573705','0','','0','0','你的手机号为15810877391,验证码为971526','0','0');
...
DROP TABLE IF EXISTS `%DB_PREFIX%interestrate`;
CREATE TABLE `%DB_PREFIX%interestrate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sn` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL,
  `use_limit` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `%DB_PREFIX%interestrate_type`;
CREATE TABLE `%DB_PREFIX%interestrate_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `rate` decimal(20,2) NOT NULL,
  `use_limit` int(11) NOT NULL,
