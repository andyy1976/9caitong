		...
		ocas.width = canvas.width = window.innerWidth-24;
		ocas.height = canvas.height = 900;
		var bigbooms = [];
		...
		function animate(){
			ctx.save();
			ctx.globalAlpha=1;
			ctx.fillStyle = "rgba(0,5,24,0.5)";
			ctx.fillRect(0,0,canvas.width,canvas.height);
			ctx.restore();
			//绘制图片
			var  pic  =  new  Image();  
			pic.src  = "/new/images/slide/bg8.jpg" ;  
