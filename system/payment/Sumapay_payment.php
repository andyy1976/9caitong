...
// | jctp2p  (Build on ThinkPHP)

// | Copyright (c) 2009 http://www.jiuchengjr.com All rights reserved.
...
class Sumapay_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$merAcct = trim($payment_info['config']['mer_acct']);//'';//$_REQUEST['merAcct'];//产品供应商的编码，一般为商户代码
