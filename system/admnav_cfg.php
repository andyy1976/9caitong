...
//									array("name"=>"会员撤销","module"=>"UserCarry","action"=>"reback"),
                ...
                "order"	=>	array(
                    ...
                    "nodes"	=>	array(
                        ...
                        array("name"=>"银行卡配置","module"=>"Banks","action"=>"index"),
                    ),
                ),
					"moneylog"=>array(
							"name"	=>	"资金日志",
	...
	"statistics"	=>	array(
				...
				"groups"	=>	array(
                    ...
                    "conf_statistics"	=>	array(
                        ...
                        "key"	=>	"conf_statistics",
                        "nodes"	=>	array(
                            array("name"=>"首页数据配置列表","module"=>"StatisticsConf","action"=>"index"),
...
//				),
				"frontconfig"	=>	array(
						...
						"nodes"	=>	array(
								...
								array("name"=>"活动设置","module"=>"Act","action"=>"index"),
						),
				),
                "banner"	=>	array(
                    "name"	=>	"活动banner配置",
                    "key"	=>	"banner",
                    "nodes"	=>	array(
                        array("name"=>"活动banner列表","module"=>"Activity","action"=>"index"),
                    ),
                ),
				"link"	=>	array(
						"name"	=>	"友情链接",
			...
			"groups"	=>	array(
				"mobile"	=>	array(
						...
						"nodes"	=>	array( 
							...
							//array("name"=>"启动页配置","module"=>"Start","action"=>"index"),
							array("name"=>"广告列表","module"=>"MAdv","action"=>"index"),
							array("name"=>"移动端ICON分组","module"=>"IconGroup","action"=>"index"),
							array("name"=>"移动端ICON列表","module"=>"Icon","action"=>"index"),
							array("name"=>"APP内应用页配置","module"=>"AppInternal","action"=>"index"),
						),
				),
				"homemodule"	=>	array(
						"name"	=>	"首页模块管理",
						"key"	=>	"homemodule",
						"nodes"	=>	array(
								array("name"=>"闪屏广告列表","module"=>"AppSplashScreen","action"=>"index"),
								array("name"=>"首页banner列表","module"=>"AppNav","action"=>"index"),
								array("name"=>"弹窗通知列表","module"=>"AppPopup","action"=>"index"),
								array("name"=>"首页栏目设置","module"=>"AppCloumn","action"=>"index"),
								array("name"=>"存管描述","module"=>"AppIps","action"=>"index"),
						),
				),
				"fxmodule"	=>	array(
						"name"	=>	"发现模块管理",
						"key"	=>	"fxmodule",
						"nodes"	=>	array(
								array("name"=>"发现banner列表","module"=>"AppFxNav","action"=>"index"),
								array("name"=>"发现栏目设置","module"=>"AppFxCloumn","action"=>"index"),
								array("name"=>"活动列表","module"=>"AppActivity","action"=>"index"),
						),
				),
				"msgmodule"	=>	array(
						"name"	=>	"消息中心管理",
						"key"	=>	"msgmodule",
						"nodes"	=>	array(
								array("name"=>"消息列表","module"=>"AppMsg","action"=>"index"),
								array("name"=>"消息分类","module"=>"AppMsgCate","action"=>"index"),
						),
				),
				"helpgmodule"	=>	array(
						"name"	=>	"帮助中心管理",
						"key"	=>	"msgmodule",
						"nodes"	=>	array(
								array("name"=>"帮助列表","module"=>"AppHelp","action"=>"index"),
								array("name"=>"帮助分类","module"=>"AppHelpCate","action"=>"index"),
						),
				),
				"webview"	=>	array(
						"name"	=>	"WEBVIEW管理",
						"key"	=>	"webview",
						"nodes"	=>	array(
								array("name"=>"WEBVIEW列表","module"=>"AppWebView","action"=>"index"),
						),
				),
				"version"	=>	array(
						"name"	=>	"移动端更新配置",
						"key"	=>	"version",
						"nodes"	=>	array(
								array("name"=>"移动端更新配置","module"=>"AppVersion","action"=>"index"),
						),
				),
			),
	),
	...
	"Marketing"	=>	array(
			...
			"groups"	=>	array(
					...
					"learnlist"  =>  array(
			                ...
			                "key"   =>  "learnlist", 
			                "nodes" =>  array(
								array("name"=>"体验金配置","module"=>"Learn","action"=>"activity_setting"),
			                    array("name"=>"体验金发放列表","module"=>"Learn","action"=>"learn_send_list"),
			                    array("name"=>"体验金使用记录","module"=>"Learn","action"=>"taste_use_log"),
			                ),
			           ),
    ...
    "reissue"	=>	array(
        ...
        "groups"	=>	array(
			"reissue"	=>	array(
				...
				"key"	=>	"reissue",
				"nodes"	=>	array(
					array("name"=>"代金券列表","module"=>"Reissue","action"=>"index"),
					array("name"=>"代金券补发","module"=>"Reissue","action"=>"add"),
					//array("name"=>"QQ客服配置","module"=>"Conf","action"=>"qq"),
				),
			),
            "redpacket"	=>	array(
                ...
                "key"	=>	"redpacket",
                "nodes"	=>	array(
					array("name"=>"红包列表","module"=>"Redpacket","action"=>"index"),
					array("name"=>"红包补发","module"=>"Redpacket","action"=>"add"),
                    //array("name"=>"QQ客服配置","module"=>"Conf","action"=>"qq"),
                ),
            ),
			/*"tasteCashe"	=>	array(
				...
				"key"	=>	"tasteCashe",
				"nodes"	=>	array(
					array("name"=>"体验金列表","module"=>"TasteCashe","action"=>"index"),
					array("name"=>"体验金补发","module"=>"TasteCashe","action"=>"add"),
					//array("name"=>"QQ客服配置","module"=>"Conf","action"=>"qq"),
			...
			"awardStyle"	=>	array(
				...
				"key"	=>	"awardStyle",
				"nodes"	=>	array(
					array("name"=>"活动列表","module"=>"AwardStyle","action"=>"index"),
					array("name"=>"活动奖励添加","module"=>"AwardStyle","action"=>"add"),
					//array("name"=>"QQ客服配置","module"=>"Conf","action"=>"qq"),
