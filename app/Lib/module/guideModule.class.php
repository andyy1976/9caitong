...
class guideModule  extends SiteBaseModule {
    function index() {
		...
		{	
			...
			$GLOBALS['tmpl']->assign("page_title","新手专区");
			$GLOBALS['tmpl']->assign("page_keyword","新手专区");
			$GLOBALS['tmpl']->assign("page_description","新手专区");
			
		}
		$GLOBALS['tmpl']->assign("ACTION_NAME","guide");
