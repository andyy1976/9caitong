...
class uc_traderModule extends SiteBaseModule
{
	...
	public function do_investment()
	{
		...
		{
			require_once APP_ROOT_PATH."system/libs/user.php";
			modify_account(array('money'=>-$order_info['borrow_money'],'lock_money'=>$order_info['borrow_money']), $GLOBALS["user_info"]["id"],'配资出借冻结,配资编号:'.$order_info["id"],36);
